...
namespace SBSEngine.Runtime.Binder
{
    public static class BinaryOperationDelegate
    {
        ...
        // TODO: As the increase of the operators, it's really hard to maintain those code. Try a better way. 
        ...
        #region GreaterThan Operation Methods
        public static T GreaterThanOperation<T>(object left, object right)
        {
            if (BothNumeric(left, right))
            {
                if (left.GetType() == right.GetType())
                {
                    if (left.GetType() == typeof(int))
                        return (T)(Object)new Func<CallSite, object, object, SBSOperator, object>(IntGreaterThan);
                    else if (left.GetType() == typeof(double))
                        return (T)(Object)new Func<CallSite, object, object, SBSOperator, object>(DoubleGreaterThan);
                }
                else
                {
                    if (left.GetType() == typeof(double))
                        return (T)(Object)new Func<CallSite, object, object, SBSOperator, object>(DoubleGreaterThanInt);
                    else
                        return (T)(Object)new Func<CallSite, object, object, SBSOperator, object>(IntGreaterThanDouble);
                }
            }
        ...
        public static object IntGreaterThan(CallSite site, object left, object right, SBSOperator op)
        {
            if (left.GetType() == typeof(int) && right.GetType() == typeof(int))
            {
                return (int)left > (int)right;
        ...
        public static object DoubleGreaterThan(CallSite site, object left, object right, SBSOperator op)
        {
            if (left.GetType() == typeof(double) && right.GetType() == typeof(double))
            {
                return (double)left > (double)right;
        ...
        public static object IntGreaterThanDouble(CallSite site, object left, object right, SBSOperator op)
        {
            if (left.GetType() == typeof(int) && right.GetType() == typeof(double))
            {
                return (int)left > (double)right;
        ...
        public static object DoubleGreaterThanInt(CallSite site, object left, object right, SBSOperator op)
        {
            if (left.GetType() == typeof(double) && right.GetType() == typeof(int))
            {
                return (double)left > (int)right;
